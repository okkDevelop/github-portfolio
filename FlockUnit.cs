...
public class FlockUnit : MonoBehaviour
{
	...
	[SerializeField] private Vector3[] directionToCheckWhenAvoidingObstacles;
	...
	public moveAway moveAwayScript;
	...
	void Start() 
	{
		moveAwayScript = GameObject.FindObjectOfType<moveAway>();
	}
	...
	public void MoveUnit()
	{
		...
		var cohesionVector = CalculateCogesionVector() * assignedFlock.cohesionWeight;
		var avoidanceVector = CalculateAvoidanceVector() * assignedFlock.avoidanceWeight;
		var aligementVector = CalculateAligementVector() * (assignedFlock.aligementWeight + moveAwayScript.runOrStay);
	...
	private Vector3 CalculateCogesionVector()
	{
	...
	private Vector3 FindBestDirectionToAvoidObstacle()
	{
		...
		for(int i = 0; i < directionToCheckWhenAvoidingObstacles.Length; i++)
		{
			RaycastHit hit;
			var currentDirection = myTransform.TransformDirection(directionToCheckWhenAvoidingObstacles[i].normalized);
